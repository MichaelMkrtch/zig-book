...
## Build Modes
Zig allows you to use different build-optimization modes called Debug, ReleaseSafe, ReleaseFast, and ReleaseSmall.
...
1. `Debug` (default):
  ...
  * **DebugInfo**: Full debug information.
2. `ReleaseSafe`:
...
4. `ReleaseSmall`:
  ...
  * **DebugInfo**: Usually none. Useful for embedded systems or environments where binary size is critical.
